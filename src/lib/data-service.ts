  ...
  async getSales(
    ...
    try {
      ...
      const salesData = mockSales.find((s: SalesSummary) => {
        ...
        if (range === "7d")
          return s.periodStart === "2026-01-28" && s.periodEnd === "2026-02-03";
        if (range === "30d")
          return s.periodStart === "2026-01-05" && s.periodEnd === "2026-02-03";
        if (range === "90d")
          return s.periodStart === "2025-11-06" && s.periodEnd === "2026-02-03";
        return false;
      });
